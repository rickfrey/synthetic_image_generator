...
{
    {
      ...
      {
      */// ÜBER ALLE PITCH UND JAW!!! AUCH IN TEXTDATEI-OPERATION SCHREIBEN!!!
        float x=1.6,y=1.6,z=1.2;
        //Visualize
        ...
        camera->SetPosition(x,y,1.2);
        camera->SetFocalPoint(x+1,y,1.2);
        camera->SetRoll(90);
        camera->Pitch(-40);
        camera->Yaw(55);
        camera->SetViewAngle(49.9); // 63.1 für Galaxy, 49.9 für iPhone 3GS
...
*/
        ...
        myfile << x << y << z << "; Roll, Pitch, Yaw" <<std::endl; // TODO: PITCH, YAW
